...
import { Prisma, Bid as PrismaBid, Job as PrismaJob } from "@prisma/client";
...
export class BidServiceBase {
  ...
  async AdminManageBid(args: UserFindUniqueArgs): Promise<string> {
    throw new Error("Not implemented");
  }
  async EditorManageBid(args: UserFindUniqueArgs): Promise<string> {
    throw new Error("Not implemented");
  }
  async UserManageBid(args: UserFindUniqueArgs): Promise<string> {
    throw new Error("Not implemented");
  }
}
