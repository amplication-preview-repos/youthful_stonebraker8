...
export class PaymentServiceBase {
  ...
  async AdminManagePayment(args: UserFindUniqueArgs): Promise<string> {
    throw new Error("Not implemented");
  }
  async EditorManagePayment(args: UserFindUniqueArgs): Promise<string> {
    throw new Error("Not implemented");
  }
  async UserManagePayment(args: UserFindUniqueArgs): Promise<string> {
    throw new Error("Not implemented");
  }
}
