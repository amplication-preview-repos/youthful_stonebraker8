...
export class PaymentControllerBase {
  ...
  @common.Post("/admin/manage-payment")
  ...
  async AdminManagePayment(
    ...
    return this.service.AdminManagePayment(body);
  }

  @common.Put("/editor/manage-payment")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async EditorManagePayment(
    ...
    return this.service.EditorManagePayment(body);
  }

  @common.Post("/user/manage-payment")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async UserManagePayment(
    ...
    return this.service.UserManagePayment(body);
  }
}
