...
export class ReviewServiceBase {
  ...
  async AdminManageReview(args: UserFindUniqueArgs): Promise<string> {
    throw new Error("Not implemented");
  }
  async EditorManageReview(args: UserFindUniqueArgs): Promise<string> {
    throw new Error("Not implemented");
  }
  async UserManageReview(args: UserFindUniqueArgs): Promise<string> {
    throw new Error("Not implemented");
  }
}
