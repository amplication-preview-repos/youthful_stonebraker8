...
export class ReviewControllerBase {
  ...
  @common.Post("/admin/manage-review")
  ...
  async AdminManageReview(
    @common.Body()
    body: UserFindUniqueArgs
  ): Promise<string> {
    return this.service.AdminManageReview(body);
  }

  @common.Put("/editor/manage-review")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async EditorManageReview(
    @common.Body()
    body: UserFindUniqueArgs
  ): Promise<string> {
    return this.service.EditorManageReview(body);
  }

  @common.Post("/user/manage-review")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async UserManageReview(
    @common.Body()
    body: UserFindUniqueArgs
  ): Promise<string> {
    return this.service.UserManageReview(body);
  }
}
